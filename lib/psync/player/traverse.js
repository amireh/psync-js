define(function(require) {
  ...
  var traverse = function(records, callbacks) {
    ...
    records.forEach(function(entry) {
      ...
      var scopeChain = entry.path.split('/');
      ...
      if (!scope) {
        console.warn("Unable to resolve scope at:", entry.path);
        return;
      }
      ...
      if (!collection) {
        console.warn("Unable to resolve collection at:", entry.path);
        return;
      }

      operationEntries = entry.operations;
